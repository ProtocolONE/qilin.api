...
func (service *membershipService) Init() error {
	...
	service.enforcer.AddPolicy(rbac.Policy{Role: model.VendorOwner, Domain: "vendor", ResourceId: "skip", Action: "any", ResourceType: model.PackageType, Effect: "allow"})
	service.enforcer.AddPolicy(rbac.Policy{Role: model.VendorOwner, Domain: "vendor", ResourceId: "skip", Action: "any", ResourceType: model.PackageListType, Effect: "allow"})
	service.enforcer.AddPolicy(rbac.Policy{Role: model.VendorOwner, Domain: "vendor", ResourceId: "skip", Action: "any", ResourceType: model.RoleBundle, Effect: "allow"})
	service.enforcer.AddPolicy(rbac.Policy{Role: model.VendorOwner, Domain: "vendor", ResourceId: "skip", Action: "any", ResourceType: model.RoleBundleList, Effect: "allow"})
	...
	service.enforcer.AddPolicy(rbac.Policy{Role: model.Support, Domain: "vendor", ResourceType: model.RoleUserType, ResourceId: "skip", Action: "read", Effect: "allow"})
	...
	service.enforcer.AddPolicy(rbac.Policy{Role: model.Admin, Domain: "vendor", ResourceType: model.RoleUserType, ResourceId: "skip", Action: "read", Effect: "allow"})

	service.enforcer.AddPolicy(rbac.Policy{Role: model.Manager, Domain: "vendor", ResourceType: model.GameType, ResourceId: "*", Action: "any", Effect: "allow"})
	service.enforcer.AddPolicy(rbac.Policy{Role: model.Manager, Domain: "vendor", ResourceType: model.GameListType, ResourceId: "skip", Action: "any", Effect: "allow"})
	service.enforcer.AddPolicy(rbac.Policy{Role: model.Manager, Domain: "vendor", ResourceType: model.PackageType, ResourceId: "*", Action: "any", Effect: "allow"})
	service.enforcer.AddPolicy(rbac.Policy{Role: model.Manager, Domain: "vendor", ResourceType: model.PackageListType, ResourceId: "skip", Action: "any", Effect: "allow"})
	service.enforcer.AddPolicy(rbac.Policy{Role: model.Manager, Domain: "vendor", ResourceType: model.RoleBundle, ResourceId: "*", Action: "any", Effect: "allow"})
	service.enforcer.AddPolicy(rbac.Policy{Role: model.Manager, Domain: "vendor", ResourceType: model.RoleBundleList, ResourceId: "skip", Action: "any", Effect: "allow"})
	service.enforcer.AddPolicy(rbac.Policy{Role: model.Manager, Domain: "vendor", ResourceType: model.VendorGameType, ResourceId: "skip", Action: "any", Effect: "allow"})
	service.enforcer.AddPolicy(rbac.Policy{Role: model.Manager, Domain: "vendor", ResourceType: model.MessagesType, ResourceId: "skip", Action: "any", Effect: "allow"})
	service.enforcer.AddPolicy(rbac.Policy{Role: model.Manager, Domain: "vendor", ResourceType: model.DocumentsType, ResourceId: "skip", Action: "any", Effect: "allow"})
	service.enforcer.AddPolicy(rbac.Policy{Role: model.Manager, Domain: "vendor", ResourceType: model.RolesType, ResourceId: "skip", Action: "read", Effect: "allow"})
	service.enforcer.AddPolicy(rbac.Policy{Role: model.Manager, Domain: "vendor", ResourceType: model.VendorType, ResourceId: "skip", Action: "any", Effect: "allow"})
	service.enforcer.AddPolicy(rbac.Policy{Role: model.Manager, Domain: "vendor", ResourceType: model.RoleUserType, ResourceId: "skip", Action: "read", Effect: "allow"})
